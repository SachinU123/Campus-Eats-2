...
android {
    namespace = "com.campuseats.campus_eats_ag"
    ...
    defaultConfig {
        ...
        applicationId = "com.campuseats.campus_eats_ag"
...
dependencies {
    // Required for flutter_local_notifications and firebase_messaging on Android
